    ...
    >
      ...
      >
        ...
        <div 
          ...
          style={{
            background: 'linear-gradient(to bottom, rgba(5,17,15,0.4), rgba(5,17,15,0.85), rgba(5,17,15,1))'
          }}
        />
      </div>

      {/* Content */}
      <div className=\"relative z-10 max-w-7xl mx-auto px-6 md:px-12 lg:px-24 py-20 md:py-32\">
        <div className=\"max-w-3xl mx-auto text-center\">
          ...
          >
            Агрегатор программ для городских жителей, которым нужна пауза. Собрали проверенные форматы 
            от разных организаторов — чтобы вы нашли свой способ восстановиться, даже если пока 
            не знаете, что именно ищете.
          </p>
